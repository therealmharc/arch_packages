...
- Graphics applications (GIMP, Inkscape, Krita)
- Office suite (LibreOffice)
- Utilities (Android tools, speedtest-cli, SSH tools)
- GNOME applications and extensions

### AUR Packages
- Additional browsers (Google Chrome, Opera)
- Development tools (Android SDK, Sublime Text)
- System utilities (downgrade, GDM settings)
- Communication apps (WhatsApp client)
